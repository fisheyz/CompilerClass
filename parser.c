...
union YYSTYPE
{
#line 31 "parser.bison" /* yacc.c:355  */
...
static const char *const yytname[] =
{
  ...
  "MOD", "ATTR", "LRTHAN", "GRTHAN", "EQ", "_PARENS", "PARENS_", "_CURLY",
  "CURLY_", "TRUE", "FALSE", "$accept", "program", "expr_list", "expr", YY_NULLPTR
};
#endif
...
#line 62 "parser.bison" /* yacc.c:1646  */
    { root = (yyvsp[0].list); }
#line 1243 "parser.c" /* yacc.c:1646  */
    break;

  case 3:
#line 64 "parser.bison" /* yacc.c:1646  */
    { (yyval.list) = mkList((yyvsp[0].exprValue),NULL); }
#line 1249 "parser.c" /* yacc.c:1646  */
    break;

  case 4:
#line 65 "parser.bison" /* yacc.c:1646  */
    { (yyval.list) = mkList((yyvsp[-1].exprValue),(yyvsp[0].list)); }
...
#line 92 "parser.bison" /* yacc.c:1906  */
